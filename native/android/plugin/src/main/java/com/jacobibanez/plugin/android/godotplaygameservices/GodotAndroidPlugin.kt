...
class GodotAndroidPlugin(godot: Godot) : GodotPlugin(godot) {
    ...
    /**
     * Resolves a saved-game conflict with caller-selected data and metadata.
     *
     * @param conflictId The conflict ID emitted by the snapshot conflict signal.
     * @param snapshotId The snapshot ID whose metadata should be retained.
     * @param resolutionData The merged or selected binary game data.
     * @param description The resolved save description.
     * @param playedTimeMillis The resolved played time in milliseconds.
     * @param progressValue The resolved progress value.
     */
    @UsedByGodot
    fun resolveSnapshotConflict(
        conflictId: String,
        snapshotId: String,
        ...
        playedTimeMillis: Long,
        progressValue: Long
    ) = snapshotsProxy.resolveConflict(
        conflictId,
        snapshotId,
        resolutionData,
        description,
