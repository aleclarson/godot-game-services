...
fun getSignals(): MutableSet<SignalInfo> = mutableSetOf(
    ...
    SnapshotSignals.conflictResolved,
...
object SnapshotSignals {
    ...
    /**
     * This signal is emitted after attempting to resolve a snapshot conflict.
     *
     * @return Whether the conflict was resolved and a JSON snapshot or error payload.
     */
    val conflictResolved = SignalInfo(
        "conflictResolved",
        Boolean::class.javaObjectType,
        String::class.java
    )
